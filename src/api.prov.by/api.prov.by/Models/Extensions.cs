...
namespace api.prov.by.Models
{
    ...
    {
        private static readonly char[] charArray = "%qazxswedcrfvtgbnhyujmkiolp!5647382910$".ToCharArray();
        private static readonly Random rnd = new Random();

        public static string GeneratePass(int lenght)
        {
            return new string(Enumerable.Repeat(charArray, lenght)
        ...
        public static string EncryptString(string key, string plainString)
        {
            byte[] iv = new byte[16];
            byte[] array;
